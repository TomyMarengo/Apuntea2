...
public class SubjectJpaDao implements SubjectDao {
    ...
    public List<Subject> getSubjectsByCareerId(UUID careerId) {
        //TODO: optimize
        List<SubjectCareer> subjectsCareers = em.createQuery("SELECT DISTINCT sc FROM SubjectCareer sc JOIN FETCH sc.subject s JOIN FETCH sc.career c WHERE c.careerId = :careerId", SubjectCareer.class)
