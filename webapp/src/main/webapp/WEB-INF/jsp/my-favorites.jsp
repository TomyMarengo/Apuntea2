            ...
            <div class="d-flex flex-column mt-5">
                <ul class="mini-nav">
                    ...
                    <li class="mini-nav-item">
                        <button class="btn mini-nav-button root-dir text-center ${param.tab eq null ? 'active' : (param.tab eq 0 ? 'active' : '')}" data-toggle="tab"
                                role="tab" aria-selected="true">
                            <spring:message code="profileNotes.subjects"/>
                        </button>
                    </li>
                    <li class="mini-nav-item">
                        <button class="btn mini-nav-button root-dir text-center ${param.tab eq null ? '' : (param.tab eq 1 ? 'active' : '')}" data-toggle="tab"
                                role="tab" aria-selected="true">
                            <spring:message code="profileNotes.directories"/>
                        </button>
                    </li>
                    <li class="mini-nav-item">
                        <button class="btn mini-nav-button root-dir text-center ${param.tab eq null ? '' : (param.tab eq 2 ? 'active' : '')}" data-toggle="tab"
                                role="tab" aria-selected="true">
