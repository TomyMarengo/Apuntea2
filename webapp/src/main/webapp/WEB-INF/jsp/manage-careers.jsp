...
<main>
    ...
    <div class="sidebar">
        <a class="btn nav-icon-button" href="./careers" data-bs-toggle="tooltip" data-bs-placement="right"
        ...
        <a class="btn nav-icon-button" href="./users" data-bs-toggle="tooltip" data-bs-placement="right"
