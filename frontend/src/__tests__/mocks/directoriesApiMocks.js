...
import {
    ...
    DIRECTORY_COLLECTION_CONTENT_TYPE, DIRECTORY_CREATE_CONTENT_TYPE, DIRECTORY_UPDATE_CONTENT_TYPE,
...
const directories = [
    {
        ...
        "parent": "http://localhost:8080/paw-2023b-12/api/directories/7a2f0b06-21a8-4d26-bda1-4ab2af663716",
        "self": "http://localhost:8080/paw-2023b-12/api/directories/d69cf972-0004-4adf-8e56-8a024e722b35",
        "subject": "http://localhost:8080/paw-2023b-12/api/subjects/09236392-978a-4c4a-913a-524c102f2ab0",
        "visible": true
    },
    {
        ...
        "parent": "http://localhost:8080/paw-2023b-12/api/directories/e85dbab4-e159-40b9-b08b-c4b34a5f6ac7",
        "self": "http://localhost:8080/paw-2023b-12/api/directories/cb2cc2d7-3ebe-4968-8654-1a8d6b74eabd",
        "subject": "http://localhost:8080/paw-2023b-12/api/subjects/db895f9d-b5ad-49ac-9ecc-9715f51871e1",
        "visible": true
    },
]
...
export const directoriesHandlers = [
    http.get(apiUrl("/directories/:id"), ({request, params}) => {
        if (request.headers.get("Accept") === DIRECTORY_CONTENT_TYPE) {
            const directory = directories.find(directory => directory.id === params.id);
    ...
    http.get(apiUrl("/directories/:directoryId/favorites/:userId"), ({request, params}) => {
        if (params.userId === favUserId && params.directoryId === favDirectoryId) {
            return NO_CONTENT_RESPONSE();
        } else {
            return NOT_FOUND_RESPONSE();
        }
    }),
    http.get(apiUrl("/directories"), ({request, params}) => {
