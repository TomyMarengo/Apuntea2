...
const reviews = [
  {
    ...
    note: apiUrl('/notes/0d5a1e12-fb4d-4bb7-9efe-07f3f3352739'),
    noteId: '0d5a1e12-fb4d-4bb7-9efe-07f3f3352739',
    score: 5,
    self: apiUrl(
      '/reviews/0d5a1e12-fb4d-4bb7-9efe-07f3f3352739_a4187437-724d-4a18-81d9-d751270942e2',
    ),
    user: apiUrl('/users/a4187437-724d-4a18-81d9-d751270942e2'),
    userId: 'a4187437-724d-4a18-81d9-d751270942e2',
  },
  {
    content: 'ta largo',
    createdAt: '2023-11-18T11:47:22.311',
    note: apiUrl('/notes/5d90e0a3-e8f2-4792-b676-50199c6a64b5'),
    noteId: '5d90e0a3-e8f2-4792-b676-50199c6a64b5',
    score: 5,
    self: apiUrl(
      '/reviews/5d90e0a3-e8f2-4792-b676-50199c6a64b5_a4187437-724d-4a18-81d9-d751270942e2',
    ),
    user: apiUrl('/users/a4187437-724d-4a18-81d9-d751270942e2'),
    userId: 'a4187437-724d-4a18-81d9-d751270942e2',
  },
  {
    ...
    note: apiUrl('/notes/243fb1a3-9750-4972-9bdd-8ef80e26ab01'),
    noteId: '243fb1a3-9750-4972-9bdd-8ef80e26ab01',
    score: 1,
    self: apiUrl(
      '/reviews/243fb1a3-9750-4972-9bdd-8ef80e26ab01_d92450df-9f2d-4e56-b11d-291bfa85b88b',
    ),
    user: apiUrl('/users/d92450df-9f2d-4e56-b11d-291bfa85b88b'),
  ...
  http.get(apiUrl('/reviews/:noteIdUserId'), ({ request, params }) => {
    ...
    if (request.headers.get('Accept') !== REVIEW_COLLECTION_CONTENT_TYPE) {
      let review = reviews.find(
        (review) => review.noteId === noteId && review.userId === userId,
      );
      if (review) {
